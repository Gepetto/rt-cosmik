...
mks_data = marker_data_to_dataframe(df_raw, mks_names)
...
#load urdf
human = Robot('/root/workspace/ros_ws/src/rt-cosmik/urdf/human.urdf',rt_cosmik_path) 
...
human_model = scale_human_model(human_model, start_sample_dict)
human_data = pin.Data(human_model)
human_collision_model = human.collision_model
human_visual_model = human.visual_model

# VISUALIZATION
viz = gv_init(human_model,human_collision_model,human_visual_model,start_sample_dict.keys())
