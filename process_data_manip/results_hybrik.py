...
SUBJECTS = ["Anais","Anastasia","Batiste","Claire_","Clement","Emmanuelle","Flavie","Herbert","Kahina","Marie_M","Maxime_","Mohamed","Nicolas","Zoe"]
...
for subject in SUBJECTS:
    ...
    hybrik_path = os.path.join(subject_path, "hybrik")  # hybrik folder
    ...
    for trial in list_of_trials:
        ...
        path_hybrik = os.path.join(hybrik_trials, "q_hybrik_swika.csv")
