...
SUBJECTS = [
    "Anais","Anastasia","Batiste","Bilal","Claire_","Clement","Flavie",
    "Guilhem","Kahina","Marie_M","Mathis","Maxime_","Mohamed","Nicolas",
    "Zoe","Herbert","Emmanuelle"
]
...
def export_joint_states(bagpath: Path, outdir: Path, topic: str = '/joint_states'):
    ...
    outfile = outdir / 'joint_states.csv'
