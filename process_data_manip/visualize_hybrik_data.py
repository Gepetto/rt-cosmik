...
meshes_folder_path = '/home/msabbah/pinocchio-3x/src/rt-cosmik/meshes/'
...
# input files
path_to_csv = f"/home/msabbah/pinocchio-3x/src/rt-cosmik/output/{no_trial}/hybrik/{task}/hybrik_camera_0_mks_lstm.csv"
path_to_csv_aligned = f"/home/msabbah/pinocchio-3x/src/rt-cosmik/output/{no_trial}/hybrik/{task}/hybrik_camera_0_mks_aligned.csv"
path_to_mocap_mks = f"/home/msabbah/pinocchio-3x/src/rt-cosmik/output/{no_trial}/mocap/{task}/mks_model_mocap_downsampled.csv"
...
path_q = f"/home/msabbah/pinocchio-3x/src/rt-cosmik/output/{no_trial}/hybrik/{task}/ZXY_HYBRIK.csv"
...
for ii in range(len(dict_1['r.ASIS_study']['x'])  ):
    for name in mks_names_1:
