...
path_to_csv = f"/home/msabbah/pinocchio-3x/src/rt-cosmik/output/Alessandro/mocap/robot_sanding/mks_data_gapfilled.csv"
...
q_data = pd.read_csv(f"/home/msabbah/pinocchio-3x/src/rt-cosmik/output/robot/q_mocap.csv").to_numpy()
q_data = q_data[159:, :]
