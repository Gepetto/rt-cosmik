...
for subject in included_subjects:
    ...
    for trial in included_trials:
        ...
        if args.test_over_mocap == "T":
            ...
            path_to_csv_lstm = os.path.join(base_path, f"rt-cosmik/output/{subject}/{trial}/{trial}_augmented_markers_mocap_{model_name_lower}.csv")
            ...
            path_to_csv_lstm = os.path.join(base_path, f"rt-cosmik/output/{subject}/{trial}/{trial}_augmented_markers_hpe_{model_name_lower}.csv")
