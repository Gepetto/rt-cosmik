...
```
cd existing_repo
git remote add origin https://gitlab.laas.fr/msabbah/rt-cosmik.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.laas.fr/msabbah/rt-cosmik/-/settings/integrations)
