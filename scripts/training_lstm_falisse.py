...
for case in cases:
    ...
    # %% Load settings.
    print("Training case: model type {} - case {}".format("lstm", case))
    ...
    pathData_all = os.path.join(pathData, "training_data{}_{}_{}{}{}".format(prefix_curated_datasets, 
                                                                             num_frames, poseDetector, prefix_old_data, sensitivity_model))
