...
path_to_3d_kpt = os.path.join(base_path, f"output/{no_trial}/{task}/3d_keypoints_filtred_mocap.csv")
output_csv_path = os.path.join(base_path, f"output/{no_trial}/{task}/augmented_markers_mocap.csv")
