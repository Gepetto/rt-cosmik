...
MAX_JOBS=6
RESULTS_FILE="../../Results/Tests_perfos_LSTM/results_ftF_alT_m${use_mocap}_n${add_noise}_w${use_weights}_prot${rot_prob}_maxrot${rot_max_deg}_rotscheme${rotation_scheme}_nrot${rotation_number}.csv"
LOG_DIR="../../Results/Tests_perfos_LSTM/logs_ftF_alT_m${use_mocap}_n${add_noise}_w${use_weights}_prot${rot_prob}_maxrot${rot_max_deg}_rotscheme${rotation_scheme}_nrot${rotation_number}"
mkdir -p "$LOG_DIR"
