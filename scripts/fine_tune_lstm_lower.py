...
kpts_input_lstm_lower_extended = []
for marker_name in kpts_input_lstm_lower:
    kpts_input_lstm_lower_extended.append(f"{marker_name}_x")
    kpts_input_lstm_lower_extended.append(f"{marker_name}_y")
    kpts_input_lstm_lower_extended.append(f"{marker_name}_z")
...
response_markers_lower_extended = []
for marker_name in response_markers_lower:
    response_markers_lower_extended.append(f"{marker_name}_x")
    response_markers_lower_extended.append(f"{marker_name}_y")
    response_markers_lower_extended.append(f"{marker_name}_z")
...
mks_of_interest_lower_extended = []
for marker_name in mks_of_interest_lower:
    mks_of_interest_lower_extended.append(f"{marker_name}_x")
    mks_of_interest_lower_extended.append(f"{marker_name}_y")
    mks_of_interest_lower_extended.append(f"{marker_name}_z")
...
if __name__ == "__main__":
    ...
    output_model_dir = "/mnt/c/Users/nicol/Desktop/Travail/LAAS/SFE Gepetto/rt-cosmik/src/rtcosmik/augmenter/augmentation_model/LSTM/fine_tuned_v0.3_lower"
    ...
    for subject in os.listdir(data_dir):
        ...
        subjects_metadata["name"] = subject
        subjects_metadata["height"] = float(metadata[0].strip().split(":")[1])
        subjects_metadata["weight"] = float(metadata[1].strip().split(":")[1])
    ...
    df_inputs = df_inputs[kpts_input_lstm_lower_extended + ["height", "weight"]]
    df_gt = df_gt[mks_of_interest_lower_extended]
    ...
    # === Paramètres ===
    input_dim = 47  # 15 markers * 3 coordinates + height + weight
    output_dim = 66 # 22 markers * 3 coordinates
    ...
    json_path = "/mnt/c/Users/nicol/Desktop/Travail/LAAS/SFE Gepetto/rt-cosmik/src/rtcosmik/augmenter/augmentation_model/LSTM/v0.3_lower/model.json"
    ...
    base_model.load_weights("/mnt/c/Users/nicol/Desktop/Travail/LAAS/SFE Gepetto/rt-cosmik/src/rtcosmik/augmenter/augmentation_model/LSTM/v0.3_lower/weights.h5")
