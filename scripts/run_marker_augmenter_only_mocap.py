...
model_name_upper = "model_finetuned_" + args.upper_model_id
model_name_lower = "model_finetuned_" + args.lower_model_id
    ...
    for subject in test_subjects:
        ...
        for trial in tasks_w_front:
            ...
            if args.test_over_mocap == "T":
                ...
                output_csv_path = os.path.join(base_path, f"rt-cosmik/output/{subject}/{trial}/{trial}_augmented_markers_hpe_{args.upper_model_id}-{args.lower_model_id}.csv")
            ...
            for i in range(len(data)):
                ...
                if len(keypoints_buffer) == 30:
                    ...
                    augmented_markers = augmentTRC_simple(keypoints_buffer_array, subject_mass=subject_weight, subject_height=subject_height, models = warmed_models,
                                        augmenterDir=augmenter_path, augmenter_model='v0.3', id_upper=args.upper_model_id, id_lower=args.lower_model_id)
