...
python run_marker_augmenter_only_HPE.py --upper-model-id $upper_id --lower-model-id $lower_id --test-subjects $test_subjects #--excluded-trials $excluded_trials

python ../process_data_manip/z_check_multiple_mks_gp_v_only_HPE.py --upper-model-id $upper_id --lower-model-id $lower_id \
