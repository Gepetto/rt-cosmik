...
python run_marker_augmenter.py --subject $subject --trial $trial --use-mocap T --add-noise F --fine-tune F --add-layer T --use-weights F --rot-prob 0.5 --rot-max-deg 179 --rotation-scheme prob
python ../process_data_manip/z_check_multiple_mks_gp_v.py --subject $subject --trial $trial --use-mocap T --add-noise F --fine-tune F --add-layer T --use-weights F --rot-prob 0.5 --rot-max-deg 179 --rotation-scheme prob