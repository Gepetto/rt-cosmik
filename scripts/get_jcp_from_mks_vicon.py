...
from src.rtcosmik.human_model.model_utils import get_pelvis_pose_jcp_mocap

list_of_female = ["Anais", "Anastasia", "Claire_", "Emmanuelle", "Flavie", "Kahina", "Marie", "Zoe"]
list_of_subject_wo_front = ["Anais", "Anastasia", "Mathis", "Maxime", "Flavie", "Mohamed", "Nicolas", "Zoe"]
...
tasks_wo_front = ["static","bolting","bolting_sat","crouch","crouch_object","hitting","hitting_sat","jump","lifting","lifting_fast","lower","overhead",
             "robot_sanding","robot_welding",
             "sanding","sanding_sat","sit_to_stand","squat","upper","walk","walk_front","welding","welding_sat"]
...
def compute_joint_centers_from_mks(markers, gender):
    jcp = {}

    pelvis_pose = get_pelvis_pose_jcp_mocap(markers, gender=gender)
    ...
    for subject in subjects:
        ...
        for task in tasks:
            ...
            for frame_id in range(len(mks_dict)):
                ...
                jcp = compute_joint_centers_from_mks(markers_frame, gender)
