...
if __name__ == '__main__':
    ...
    vertices_csv = os.path.join(script_dir, 'hybrik', 'smplx', f'res_{motion}_x', f'res_{motion}_x_vertices.csv')
    ...
    animate_all(viz, markers_list, vertices, marker_names, vertex_factor=opt.vertex_factor, delay=0.03)
