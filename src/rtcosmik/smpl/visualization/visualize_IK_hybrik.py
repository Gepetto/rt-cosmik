...
if __name__ == '__main__':
    ...
    markers_csv = os.path.join(script_dir, 'hybrik', 'smplx', f'{motion}', f'{motion}_mks_lstm.csv')
    ...
    meshes_folder_path = os.path.join(script_dir, '..', '..', '..', 'meshes')
    ...
    vertices_csv = os.path.join(script_dir, 'hybrik', 'smplx', f'{motion}', f'{motion}_vertices.csv')
