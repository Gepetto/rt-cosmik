...
class RebaScore:
    ...
    def __init__(self, angles_csv_path, positions_csv_path, frame_number, 
        ...
        # Step 2 params
        self.trunk = {"trunk_angle_z": self.get_joint_angle_by_name("thoracic_flex_ext"), 
                    "trunk_lateral_flexion": self.get_joint_angle_by_name("thoracic_lateral_flex"), 
                    "trunk_axial_rotation": self.get_joint_angle_by_name("thoracic_rot_int_ext")}
        ...
        # Step 9 params
        self.wrists = {"right_wrist_angle_z": self.get_joint_angle_by_name("Rwrist_flex_ext"), 
                        "left_wrist_angle_z": self.get_joint_angle_by_name("Lwrist_flex_ext"),
                        "right_wrist_angle_x": self.get_joint_angle_by_name("Rwrist_x"), 
                        "left_wrist_angle_x": self.get_joint_angle_by_name("Lwrist_x")}
